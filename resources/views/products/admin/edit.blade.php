            ...
            <form action="" method="post"  enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" class="form-control" name="name" placeholder="Name" value="{{old('name', $product->title)}}">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Amount</label>
                            <input type="text" class="form-control" name="amount" placeholder="Amount" value="{{old('amount', $product->amount)}}">
                            <p class="text-danger" style="margin: 5px 0; opacity: 1;">
                                {{ $errors->first('amount') }}
                            </p>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Image</label>
                            <a href="{{url('/images/products/'.$product->billboard)}}">Current image</a>
